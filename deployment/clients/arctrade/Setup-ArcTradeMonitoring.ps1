# =============================================================================
# ArcTrade SQL Server Monitoring - Setup Script
# =============================================================================
# This script:
#   1. Prompts for new SQL password
#   2. Resets password on all 3 servers
#   3. Creates MonitoringDB on primary server (003p_New)
...
Write-Host "  ARCTRADE SQL SERVER MONITORING - SETUP" -ForegroundColor Cyan
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""
...
-- Create linked server for 001p_New
...
-- Create linked server for 002p_New
EXEC sp_addlinkedserver
...
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "ArcTrade SQL Monitoring has been configured:" -ForegroundColor Green
Write-Host ""
